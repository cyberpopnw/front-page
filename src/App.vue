<template>
  <router-view v-slot="{ Component }">
    ...
    <component :is="Component" :key="$route.path" v-if="!$route.meta.keepAlive"/>
    <msg-popup-a v-if="innerWidth > 1025 && TipsState" :addNetwork="TipsInfo.addNetwork" :isShowTips="TipsState"
                 :isLoading="TipsInfo.hasLoading" :isClose="TipsInfo.hasClose" :title="TipsInfo.title"
                 :content="TipsInfo.content" :boxId="TipsInfo.boxId" :haveNFT="TipsInfo.haveNFT"/>
    <msg-popup-b v-if="innerWidth <= 1025 && TipsState" :addNetwork="TipsInfo.addNetwork" :isShowTips="TipsState"
                 :isLoading="TipsInfo.hasLoading" :isClose="TipsInfo.hasClose" :title="TipsInfo.title"
                 :content="TipsInfo.content" :boxId="TipsInfo.boxId" :haveNFT="TipsInfo.haveNFT"/>
    ...
    <purchaseA v-if="innerWidth > 1025 && purchaseState" :isShowTips="purchaseState" :title="purchaseInfo.title"
               :content1="purchaseInfo.content1" :content2="purchaseInfo.content2" :state="purchaseInfo.state"
               :haveNFT="purchaseInfo.haveNFT" :boxId="purchaseInfo.boxId"/>
    <purchaseB v-if="innerWidth <= 1025 && purchaseState" :isShowTips="purchaseState" :title="purchaseInfo.title"
               :content1="purchaseInfo.content1" :content2="purchaseInfo.content2" :state="purchaseInfo.state"
               :haveNFT="purchaseInfo.haveNFT" :boxId="purchaseInfo.boxId"/>
    <staking-a v-if="innerWidth > 1025 && stakingState" :isShowTips="stakingState" :haveCTY="stakingInfo.haveCTY"
               :state="stakingInfo.state"/>
    <staking-b v-if="innerWidth <= 1025 && stakingState" :isShowTips="stakingState" :haveCTY="stakingInfo.haveCTY"
               :state="stakingInfo.state"/>
