const us = {
    message:{
        ...
        mining: {
            ...
            percyt_earn: 'Interest generated by a pledged cyt',
        ...
        details: {
            ...
            intro: {
                ...
                desc3: 'Incarnation in a lower dimension. Outsiders do not have direct access to lower dimensions because their bodies can only exist in the real world, so they need a cyber shell to accommodate their consciousness; just like cyborgs, outsiders can change the entire shell beyond organs and prosthetics to fit different sizes according to their needs.',
                desc4: 'Maneli is a tribal woman born after the awakening of the Dark Gods and raised in a desert wasteland littered with corpses. During her childhood, most of her tribe was murdered in a monster attack. She survived through difficulty, meeting a group of bandits roaming the desert who took her in and raised her. Growing up, Maneli became the leader of a band of bandits named the Zahhaks, and continued to live a life of robbery in the desert. Maneli\'s parents told her many legends when she was a child, which made her long for the time of the Great Mirror before the Dark Gods awoke. As a result, she strives to collect any rituals or magic associated with time travel. While leading the Zahhaks in their search for an artifact, she encounters Kakulupia, a person with the true power to travel through time and space.',
                desc5: 'Kakulupia is a foreigner of this era, a prince from a distant time. He is considered a dead, almost forgotten hero. After Ahriman, the God of Darkness woke up, he answered the call of the Scholars of the Sand Sea to come to this era with the power of the dagger. However, due to the transformation caused by this time travel, his energy was depleted. Kakulupia witnessed the tragic condition of the Sand Sea during his search for materials with mystical energy to restore the dagger\'s power, so he decided to return to the era before Ahriman woke up in order to stop this tragedy.',
                desc6: 'In the hourglass of the golden age, there is only a bit of mysterious gravel inside. According to legend, it is a tool built by the ancients using the power to travel through time and space. But now the knowledge has been forgotten and the method of using the hourglass has been lost with the dust of history.',
                desc7: 'The liquid stored in the vial will repair hurt muscles to help continue the battle.',
