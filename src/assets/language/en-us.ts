    ...
    message:{
        ...
        details: {
            ...
            list:{
                ...
                HeroText: 'Test server player access to the game to explore the credentials, official server player privileged status symbol',
