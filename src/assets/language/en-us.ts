const us = {
    message:{
        common: {
            ...
            doc_whitePaper: 'White Paper',
            doc_greenPaper: 'Green Paper',
            doc_deck: 'Project Introduction',
            ...
            metamask: {
                ...
                wrongContent: 'You are connected to the wrong network. Please switch the current network.',
                switchMumbai: 'Mumbai',
                switchFuji: 'FUJI',
                switchBSC: 'BSC',
                switchGate: 'Gate',
