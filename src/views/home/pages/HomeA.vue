<template>
    ...
    <section>
      ...
      <div class="titles">
        <div class="title-wrap flex_center">
          <div class="title1">{{ $t('message.home.banner_title1Bef') }}<br/>{{ $t('message.home.banner_title1Aft') }}
          </div>
          <div class="title2">
      ...
      <div class="content">
        ...
        <div class="swiper1">
          <div class="swiper-bg">
            ...
            <img :class="imgIndex == 3 ? 'show' : ''" src="https://d2cimmz3cflrbm.cloudfront.net/nwhome/futureCity3.png"
                 alt="">
          </div>
  ...
  <div class="make">
    <div class="make-wrap">
      <div class="title" id="ele3">{{ $t('message.home.make_titleBef') }}<br/>{{ $t('message.home.make_titleAft') }}
      </div>
  ...
  <div class="partners">
    ...
    <div class="logo flex_centent_center">
      ...
      <a href="https://coinmarketcap.com/" target="view_window">
        <img class="logo14" src="https://d2cimmz3cflrbm.cloudfront.net/nwhome/alpha_coinMarkrt.png" alt="">
      </a>
    </div>
  </div>
  <div class="will">
    ...
    .titles {
      ...
      .title-wrap {
        ...
        .title1 {
          ...
          text-align: center;
          font-weight: 900;
          filter: drop-shadow(.155vw 0 0 #D236A5) drop-shadow(-.15vw 0 0.05rem #72F0D9);
        }
