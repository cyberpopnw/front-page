<template>
  ...
  <div class="banner">
    <section>
      <video-bg
          id="videobg" :sources="[`https://d3bhixjyozyk2o.cloudfront.net/5c64797a7cb8b72ed6255c8406b7294d.mp4`]"
          img="https://d2cimmz3cflrbm.cloudfront.net/nwhome/videobg3.png">
      </video-bg>
      <div class="titles">
        <div class="title-wrap flex_center">
          <div class="title1" id="title1">
            {{ $t('message.home.banner_title1Bef') }}<br/>{{ $t('message.home.banner_title1Aft') }}
          </div>
          <div class="title2">
            {{ $t('message.home.banner_title2') }}
          </div>
          <div class="btnbox flex_centent_center">
            <div class="btn-register flex_center" @click="playToEarn()">
              <div>{{ $t('message.home.banner_btn1') }}</div>
            </div>
      ...
      <div class="botm">#0 <span class="txt1">{{ $t('message.home.banner_botmBef') }}</span><span
          class="txt2">{{ $t('message.home.banner_botmAft') }}</span></div>
    </section>
    <footer>
  ...
  <div class="welcome">
    <div class="warp">
      <div class="title" id="ele1">{{ $t('message.home.wel_titleBef') }}<p class="white">
        {{ $t('message.home.wel_titleAft') }}</p></div>
      <div class="desc">
      ...
      <div class="content">
        ...
        <div class="swiper1">
          <div class="swiper-bg">
            ...
            <div>
              <img :class="imgIndex == 2 ? 'show' : ''"
                   src="https://d2cimmz3cflrbm.cloudfront.net/nwhome/moonlightCentury3.png" alt="">
            </div>
            <div>
              <img :class="imgIndex == 3 ? 'show' : ''"
                   src="https://d2cimmz3cflrbm.cloudfront.net/nwhome/futureCity3.png" alt="">
            </div>
          </div>
          ...
          <div class="swiper-img">
            ...
            >
              ...
              <swiper-slide><img src="https://d2cimmz3cflrbm.cloudfront.net/nwhome/moonlightCentury3.png" alt="">
              </swiper-slide>
              <swiper-slide><img src="https://d2cimmz3cflrbm.cloudfront.net/nwhome/futureCity3.png" alt="">
              </swiper-slide>
            </swiper>
          </div>
        </div>
    ...
    <div class="nobody-wrap flex_align_center">
      ...
      <div class="nobody-right flex_align_center">
        <div class="title" id="ele2">
          {{ $t('message.home.nobody_r_titleBef') }}<br/>{{ $t('message.home.nobody_r_titleAft') }}
        </div>
        ...
        <div class="video">
          ...
          <div class="video-wrap flex_center">
            <img src="https://d2cimmz3cflrbm.cloudfront.net/nwhomePhone/nobody-controls.svg" alt=""
                 @click="playVideo(4)">
          </div>
          <div class="content">
            <div class="video-title">#0 {{ $t('message.home.nobody_r_video_txtBef') }}<span
                class="yellow">{{ $t('message.home.nobody_r_video_txtAft') }}</span></div>
  ...
  <div class="news">
    <div class="news-wrap">
      ...
      <div class="news-img" @click="newsActiveSrc()">
        <img :class="{'newsShow': showNewsImg == 0}" src="https://d2cimmz3cflrbm.cloudfront.net/nwhome/news-bg-3.png"
             alt="">
        <img :class="{'newsShow': showNewsImg == 1}" src="https://d2cimmz3cflrbm.cloudfront.net/nwhome/news-bg2-3.png"
             alt="">
        <div class="desc">
      ...
      <ul @click="newsActiveSrc()">
        <li>
          <img src="https://d2cimmz3cflrbm.cloudfront.net/nwhomePhone/news-img1.png" id="myNews1" class="myNews"
               @mouseover="newsHover(0,newsStatictxt1)" @click="newsActive(0,newsStatictxt1)" alt="">
          <div class="read">
        ...
        <li>
          <img src="https://d2cimmz3cflrbm.cloudfront.net/nwhomePhone/news-img2.png" id="myNews2" class="myNews"
               @mouseover="newsHover(1,newsStatictxt2)" @click="newsActive(1,newsStatictxt2)" alt="">
          <div class="read">
...
// Section
import Partners from '@/views/home/section/mobile/Partners.vue'
    ...
    .titles {
      ...
      .title-wrap {
        ...
        .title1 {
          ...
          text-align: center;
          font-weight: 900;
          filter: drop-shadow(.4vw 0 0 #D236A5) drop-shadow(-.4vw 0 0 #72F0D9);
        }
