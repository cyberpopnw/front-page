<template>
  ...
  <div class="download bounceShow">
    <div class="banner">
      <div class="welmsg">{{ $t('message.download.welmsg_txt1') }} <span>{{ $t('message.download.welmsg_txt2') }}</span>
      </div>
      <div class="title">{{ $t('message.download.title') }}</div>
    </div>
    <div class="down_button">
      <div class="step2">
        <span class="green">{{ $t('message.download.step1_name') }} :</span> <br/>{{
          $t('message.download.download_txt')
        }} <br/>
